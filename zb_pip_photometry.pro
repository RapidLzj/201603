function zb_pip_photometry, rawpath, sci_path, file, $
    ...
    for gg = 0, ngg-1 do begin
        ...
        ; call SExtractor
        cmd = string(sexcmd, sec_fits[gg], sec_ldac[gg], sec_gain, pix_scales, sv, $
        ...
        rs = r_rot_cata(stars_sec.x - cnx, stars_sec.y- cny, rotang[gg])
        stars_sec.x = rs.x + cnx + nx0[gg]
        stars_sec.y = rs.y + cny + ny0[gg]
